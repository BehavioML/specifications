# Phase 08 — Traceability and report
...
Phase 07 must be complete.

Semantic areas, workflows, capabilities, events, state machines, decisions, and any accepted aggregated workflows should be stable enough to map back to source evidence.
